    ...
    <section class="wrapper main-wrapper" style=''>
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title">Laporan Awal Kasus <a href="index.php?mod=laporan_awal&act=baru" class="btn btn-success"> Tambah Laporan Awal Kasus</a></h1>        
                </div>
            </div>
        </div>
        <div class="clearfix"></div>

        <?php include ('function/laporan_awal-loader.php') ?>
