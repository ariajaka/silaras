<div class="modal-header">
    <a href="index.php?mod=laporan_awal&act=view" class="close">&times;</i></a>
    <h4 class="modal-title">Laporan Awal Kasus</h4>
</div>
<div class="modal-body">
	<?php include('../../../config/config.php') ?>
    <?php 
    include ('../../sql/laporan_awal/detail.php');
    ?>
    <table>
        <tr>
...
<tr>
    ...
    <td colspan="5" valign="top">
        <div style="text-align: justify;" class="badge badge-danger">
            Belum Dibuat Rekomendasi
        </div>
    </td>
</tr>
<tr>
...
<div class="modal-footer">
    <a href="index.php?mod=laporan_awal&act=view" class="btn btn-danger btn-sm"><i class="fa fa-close"> Tutup</i></a>
</div>