            ...
            <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php if($file != ''){echo '<a href="view/laporan_awal_rekom/download-laporan_awal_rekom.php?filename='.$file.'" class="badge badge-primary">Download File</div>';}else{echo "";} ?></td>
                            <td>
                                <?php 
