    ...
    <div class="content-body">    
        <div class="row">
            ...
            <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    <?php 
                        include ('sql/laporan_awal/view.php');
						$no = 0;
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php if($file != ''){echo '<a href="view/laporan_awal/download-laporan_awal.php?filename='.$file.'" class="badge badge-primary">Download File</div>';}else{echo "";} ?></td>
                            <td>
                                <a href="view/laporan_awal/detail-laporan_awal.php?id_la=<?php echo $data_laporan_awal['id_la'];?>" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-th-list"></i></a>
                                <a href="view/laporan_awal/cetak-laporan_awal.php?id_la=<?php echo $data_laporan_awal['id_la']; ?>" class="btn btn-success btn-sm" target="_blank"><i class="fa fa-print"></i></a>
                                <a href="index.php?mod=laporan_awal&act=hapus&id=<?php echo $data_laporan_awal['id_la']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
